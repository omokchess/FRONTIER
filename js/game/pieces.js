/* ===================================================================
   ...
   - 특수 기물은 '행마법이 보이는' 기호로: 방패=위아래 화살표, 스나이퍼=조준선,
     어쌔신=네 방향 도약 점.
...
(() => {
  ...
  const SHAPES = {
    ...
    B: `<circle cx="22.5" cy="8" r="2.8"/>
        ...
        ${BASE}`,
    // 나이트 — 말 머리
    N: `<path d="M14 38V26c0-5 2-8 5-11l1-4-2-3 4-1 2-3 3 2c7 2 11 8 11 17v15z"/>
        <circle cx="19" cy="17" r="1.6" class="pc-dot"/>
        <path d="M17 20c-2 2-4 3-6 3"/>`,
    // 폰 — 구슬 + 목 + 받침
    ...
    // ===== 특수 기물 — 행마법이 드러나게 =====
    // 방패: 방패 윤곽 + 앞뒤 직진을 뜻하는 위아래 화살표
    SH: `<path d="M22.5 5l13 4v12c0 9-6 15-13 19-7-4-13-10-13-19V9z"/>
         <path d="M22.5 13v18M22.5 12l-4 5M22.5 12l4 5M22.5 32l-4-5M22.5 32l4-5" class="pc-mark"/>`,
    // 스나이퍼: 조준경 + 십자선 + 사방 눈금 (제자리 원거리 저격)
    SN: `<circle cx="22.5" cy="22.5" r="13"/>
         <circle cx="22.5" cy="22.5" r="4.5" class="pc-mark"/>
         <path d="M22.5 3v9M22.5 33v9M3 22.5h9M33 22.5h9" class="pc-mark"/>`,
    // 어쌔신: 마름모 몸통 + 네 방향 도약 점 (2칸 점프)
    JP: `<path d="M22.5 10l9 12-9 12-9-12z"/>
         <circle cx="22.5" cy="4" r="2.4" class="pc-mark"/>
         <circle cx="22.5" cy="41" r="2.4" class="pc-mark"/>
         <circle cx="4" cy="22.5" r="2.4" class="pc-mark"/>
         <circle cx="41" cy="22.5" r="2.4" class="pc-mark"/>`
  };
