...
(() => {
  ...
  const SHAPES = {
    ...
    SN: `<path d="M14 22l4.5 10h8L31 22z"/>
         ...
         ${BASE}`,
    // 공성추: 좁은 탑 + 양옆 큰 바퀴 + 가운데 굵은 충각.
    // 받침은 좌우로 갈라 둔다 — 하나로 이으면 충각 끝과 겹쳐 아래가 뭉갠다.
    // 그리는 순서 = 겹치는 순서. 바퀴·받침을 깔고 탑, 충각 순으로 얹는다.
    RM: `<circle cx="9" cy="26" r="7.5"/><circle cx="36" cy="26" r="7.5"/>
         <circle cx="9" cy="26" r="2.6"/><circle cx="36" cy="26" r="2.6"/>
         <path d="M3.5 35h11v5h-11zM30.5 35h11v5h-11z"/>
         <path d="M15 4h4v4h3.5V4h4v4h3.5V4h4v6H15z"/>
         <path d="M15 10h15l1 10H14z"/>
         <path d="M19 13v4M26 13v4" class="pc-mark"/>
         <path d="M15.5 19h14v11l-7 11-7-11z"/>`,
  ...
  const XL_SHAPES = {
    ...
    SN: `<path d="M14 22l4.5 10h8L31 22z"/>
         ...
         ${BASE}`,
    // 강화 공성추 — 바퀴가 더 크고, 탑에 쇠띠, 충각이 길고 두껍다
    RM: `<circle cx="8" cy="25" r="8"/><circle cx="37" cy="25" r="8"/>
         <circle cx="8" cy="25" r="2.8"/><circle cx="37" cy="25" r="2.8"/>
         <path d="M2 34h12v6H2zM31 34h12v6H31z"/>
         <path d="M14 2h4v4h3.5V2h4v4h3.5V2h4v6H14z"/>
         <path d="M14 8h17l1 10H13z"/>
         <path d="M13.5 13h18" class="pc-mark"/>
         <path d="M18 9.5v3M27 9.5v3" class="pc-mark"/>
         <path d="M14.5 17h16v13l-8 13-8-13z"/>`,
